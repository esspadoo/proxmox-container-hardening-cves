...
- [Proxmox VE CVE-2024-21545 API demo](apiAttack/README.md)
...
```
cd existing_repo
git remote add origin https://gitlab.com/giancarlopadoan/cns-codeexamples.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/giancarlopadoan/cns-codeexamples/-/settings/integrations)
